 ...
 */
public class NormalLineAnimDrawable extends Drawable {
    ...
    private ValueAnimator getLineAnim() {
        ...
        ValueAnimator factorVa = ValueAnimator.ofFloat(0f, 1f);

        factorVa.setTarget(this);
        factorVa.setDuration(lineAnimDuration);

        factorVa.setRepeatMode(ValueAnimator.RESTART);
        factorVa.setRepeatCount(mAnimPoints.size() - 1);
        factorVa.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                try {
                    factorX = factorY = Float.valueOf(animation.getAnimatedValue() + "");
...
//            valueY.setAutoCancel(true);
//        }
        factorVa.addListener(new Animator.AnimatorListener() {
            @Override
    ...
    @NonNull
    public void setListener(Animator.AnimatorListener mListner) {
